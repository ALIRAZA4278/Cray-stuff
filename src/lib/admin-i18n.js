...
const en = {
  ...
  percentOff: "Percentage off", fixedOff: "Fixed amount off ($)", amountLabel: "Amount ($)", percentageLabel: "Percentage (%)",
...
const pl = {
  ...
  percentOff: "Procent zniżki", fixedOff: "Kwota zniżki ($)", amountLabel: "Kwota ($)", percentageLabel: "Procent (%)",
