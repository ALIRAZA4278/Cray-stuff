...
const en = {
  ...
  terms: {
    ...
    sections: [
      ...
      { h: "Shipping", body: "Orders are packed and shipped within 36 hours via InPost, Orlen Paczka, GLS or DPD. Free shipping on orders of 3 items or more; otherwise shipping is shown at checkout. International options are available at checkout." },
...
const pl = {
  ...
  terms: {
    ...
    sections: [
      ...
      { h: "Wysyłka", body: "Zamówienia pakujemy i wysyłamy w 36 godzin przez InPost, Orlen Paczka, GLS lub DPD. Darmowa wysyłka od 3 sztuk; w innym przypadku koszt widać w kasie. Opcje międzynarodowe dostępne w kasie." },
