  ...
  return (
    <div className="relative flex h-full min-h-[320px] flex-col justify-end overflow-hidden rounded-lg border border-border p-8">
      ...
      <div className="relative z-10">
        <p className="font-mono text-xs uppercase tracking-widest text-accent">{t.hmOurPhilosophy}</p>
        <h2 className="mt-3 text-2xl font-semibold uppercase tracking-tight text-white">{t.hmSecondLifeFirstChoice}</h2>
        <ScrollRevealText
          text={t.hmBrandStoryText}
